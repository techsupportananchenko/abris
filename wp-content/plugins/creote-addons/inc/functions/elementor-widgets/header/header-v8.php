<?php
   ...
   class Widget_creote_header_v8 extends Widget_Base
   {
       ...
       protected function render()
       {
           ...
           ?>
<header class="header header_default style_seven style_eight head_<?php echo esc_attr($settings['header_positions']); ?>"> <div class="container-fluid"> <div class="row align-items-center"> <div class="col-lg-2 col-md-8 col-sm-8 col-xs-8 logo_column"> <div class="header_logo_box"> <a href="<?php echo esc_url($url); ?>" class="logo navbar-brand" <?php echo esc_attr($logo_target); ?> <?php echo esc_attr($logo_nofollow); ?>> <img src="<?php echo esc_url($settings['logo_default']['url']); ?>" alt="<?php echo esc_html(get_bloginfo( 'name' )); ?>" class="logo_default"> </a> </div> </div> <div class="col-lg-6 col-md-1 col-sm-1 col-xs-1 menu_column"> <div class="navbar_togglers hamburger_menu"> <span class="line"></span> <span class="line"></span> <span class="line"></span> </div> <div class="header_content_collapse"> <div class="header_menu_box"> <div class="navigation_menu text-left"> <?php if(!empty($settings['navigations'])): wp_nav_menu(array( 'menu' => $settings['navigations'], 'container' => false, 'menu_class' => 'navbar_nav', 'menu_id' => 'myNavbar', 'fallback_cb' => 'WP_Bootstrap_Navwalker::fallback', 'walker' => new \WP_Bootstrap_Navwalker() ) ); endif; ?> </div> </div> </div> </div> <div class="col-lg-4 col-md-3 col-sm-3 col-xs-3 right_column"> <div class="header_right_content"> <ul> <?php if($settings['search_enable'] == 'yes'): ?> <li> <button type="button" class="search-toggler"><i class="icon-search"></i></button> </li> <?php endif;?> <?php if($settings['cart_enable'] == 'yes'): if(class_exists('woocommerce')): ?> <li> <?php $items_counts = is_object( WC()->cart ) ? WC()->cart->get_cart_contents_count() : ''; ?> <div class="mini_cart_togglers header_side_cart"> <div class="mini-cart-count"> <?php if(!empty($items_counts)): echo $items_counts ? $items_counts : '&nbsp;'; else: echo esc_html('0'); endif; ?> </div> <i class="icon-shopping-bag1"></i> </div> </li> <?php endif; endif;?> <?php if($settings['modal_enable'] == 'yes'): ?> <li> <button type="button" class="contact-toggler"><i class="icon-menu1"></i></button> </li> <?php endif;?> <?php if($settings['button__text_enable'] == 'yes'): ?> <li class="last"> <?php $target_four = $settings['button_text_link']['is_external'] ? ' target="_blank"' : ''; $nofollow_four = $settings['button_text_link']['nofollow'] ? ' rel="nofollow"' : ''; ?> <a href="<?php echo esc_url($settings['button_text_link']['url']); ?>" <?php echo esc_attr($target_four); ?> <?php echo esc_attr($nofollow_four); ?> class="login"> <i class="icon-keyhole"></i> <?php echo esc_attr($settings['button_link_text']); ?> </a> </li> <li> <?php endif;?> <?php if($settings['scoial_media_enables'] == 'yes'): ?> <div class="med_rg_side"> <ul class="social_media_head"> <?php foreach($settings['social_media_repeaters'] as $media_repearter):?> <?php $targetm = $media_repearter['socail_media_links']['is_external'] ? ' target="_blank"' : ''; $nofollowm = $media_repearter['socail_media_links']['nofollow'] ? ' rel="nofollow"' : ''; ?> <li> <a href="<?php echo esc_url($media_repearter['socail_media_links']['url']); ?>" <?php echo esc_attr($targetm); ?> <?php echo esc_attr($nofollowm); ?>> <?php if($media_repearter['media_icon_enable'] == 'text_type'): ?> <small><?php echo esc_attr($media_repearter['social_media_text']); ?></small> <?php elseif($media_repearter['media_icon_enable'] == 'icon_type'): ?> <i class="<?php echo esc_attr($media_repearter['social_media_icons']); ?>"></i> <?php endif; ?> </a> </li> <?php endforeach;?> </ul> </div> </li> <?php endif;?> </ul> </div> </div> </div> </div></header>
<?php
}
}
