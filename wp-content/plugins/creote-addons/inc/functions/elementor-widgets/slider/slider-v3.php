<?php
   ...
   class Widget_creote_slider_v3 extends Widget_Base
   {
       ...
       protected function render()
       {
          ...
          ?>
<section class="slider style_one slider_version_v3 <?php echo esc_attr($settings['pag_positions']); ?> <?php echo esc_attr($settings['nav_positions']); ?>"> <div class="banner-carousel theme_carousel owl-theme owl-carousel" data-options='{"loop": <?php echo esc_attr($loop_enable); ?>, "margin": 0, "autoheight":true, "lazyload":true, "nav": true, "dots": true, "autoplay": <?php echo esc_attr($autoplay_enable); ?>, "autoplayTimeout": <?php echo esc_attr($settings['autplaytimeout']); ?>, "smartSpeed": <?php echo esc_attr($settings['sliderspeed']); ?>, "responsive":{ "0" :{ "items": "1" }, "768" :{ "items" : "1" } , "1000":{ "items" : "1" }}}'> <?php foreach($settings['v2_slider_repeater_one'] as $key => $v2_slider_repeater_one): $content_paddings = $v2_slider_repeater_one['content_padding']; $content_paddings = ! empty( $content_paddings ) ? "padding: $content_paddings;" : ''; $content_paddingscss = 'style="'.$content_paddings.'"'; ?> <div class="slide-item"> <div class="slide-item-content"> <div class="image-layer" <?php if(!empty($v2_slider_repeater_one['slider_background_image']['url'])): ?> style="background-image:url(<?php echo esc_url($v2_slider_repeater_one['slider_background_image']['url']); ?>)" <?php endif; ?>></div> <div class="<?php echo esc_attr($settings['container_width']); ?>"> <div class="contnet_d_flex"> <div class="text_box_content"> <div class="slider_content" <?php if(!empty($content_paddingscss)): ?> <?php echo __($content_paddingscss); ?> <?php endif; ?>> <?php if(!empty($v2_slider_repeater_one['small_heading_enable'] == 'yes')): ?> <h6 class="animated <?php echo esc_attr($v2_slider_repeater_one['small_heading_trans']); ?>"> <?php echo wp_kses($v2_slider_repeater_one['small_heading'] , $allowed_tags); ?> </h6> <?php endif; ?> <?php if(!empty($v2_slider_repeater_one['heading_enable'] == 'yes')): ?> <h1 class="animated <?php echo esc_attr($v2_slider_repeater_one['heading_trans']); ?>"> <?php echo wp_kses($v2_slider_repeater_one['heading'] , $allowed_tags); ?> </h1> <?php endif; ?> <?php if(!empty($v2_slider_repeater_one['description_enable'] == 'yes')): ?> <p class="animated <?php echo esc_attr($v2_slider_repeater_one['description_trans']); ?>"> <?php echo wp_kses($v2_slider_repeater_one['description'] , $allowed_tags); ?> </p> <?php endif; ?> <?php if(!empty($v2_slider_repeater_one['list_enable'] == 'yes')): ?> <?php if(!empty($v2_slider_repeater_one['list_text'])): ?> <ul class="animated <?php echo esc_attr($v2_slider_repeater_one['list_trans']); ?>"> <?php $list_texts = explode("\n", ($v2_slider_repeater_one['list_text']));?> <?php foreach($list_texts as $list_text):?> <li> <?php echo wp_kses($list_text, true); ?> </li> <?php endforeach; ?> </ul> <?php endif; ?> <?php endif; ?> <?php if(!empty($v2_slider_repeater_one['button'])) :?> <?php $target = $v2_slider_repeater_one['button_link']['is_external'] ? ' target="_blank"' : ''; $nofollow = $v2_slider_repeater_one['button_link']['nofollow'] ? ' rel="nofollow"' : ''; ?> <div class="thm_btn animated <?php echo esc_attr($v2_slider_repeater_one['button_trans']); ?>"> <a href="<?php echo esc_url($v2_slider_repeater_one['button_link']['url']); ?>" <?php echo esc_attr($target); ?> <?php echo esc_attr($nofollow); ?> class="theme-btn two animated <?php echo esc_attr($v2_slider_repeater_one['button_trans']); ?>"> <?php echo esc_html($v2_slider_repeater_one['button']); ?> </a> </div> <?php endif; ?> </div> </div> <div class="image_content"> <?php if(!empty($v2_slider_repeater_one['slider_image']['url'])) : $image = isset($v2_slider_repeater_one['slider_image']['alt']) ? $v2_slider_repeater_one['slider_image']['alt'] : ''; if(!empty($image)) { $image = $image; }else{ $image = 'image'; } ?> <div class="slider_image <?php echo esc_attr($v2_slider_repeater_one['image_trans']); ?>"> <img src="<?php echo esc_url($v2_slider_repeater_one['slider_image']['url']); ?>" class="img-fluid" alt="<?php echo esc_attr($image); ?>" /> </div> <?php endif; ?> </div> </div> </div> </div> </div> <?php endforeach;?> </div> <?php if($settings['contact_enable'] == 'yes'): ?> <div class="auto-container pr_relative"> <div class="contact_box_ban"> <div class="icon_bx"> <span class="<?php echo esc_attr($settings['icon_fonts']); ?>"></span> </div> <div class="conent_bx"> <?php if(!empty($settings['contact_title'])): ?> <h6><?php echo wp_kses($settings['contact_title'] , $allowed_tags); ?></h6> <?php endif; ?> <?php if(!empty($settings['contact_content'])): ?> <p><?php echo wp_kses($settings['contact_content'] , $allowed_tags); ?></p> <?php endif; ?> </div> </div> </div> <?php endif; ?> </section>
<?php
}
}
